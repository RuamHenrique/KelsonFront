...
<Card className="text-center h-100 shadow-sm">
            ...
            <Card className="text-center h-100 shadow-sm">
                    ...
                    <Card.Body>
                        ...
                        <Card.Text>
                            O centro de nossa instituicao com salas modernas
 ...
 <Card className="h-100 shadow-sm">
            ...
            <Card.Body className="text-center">
                <Card.Title>Compromisso com educacao</Card.Title>
                <Card.Text>

                    Mantemos nosso compromisso com a educacao de alto padrao
                </Card.Text>
